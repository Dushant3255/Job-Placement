...
public class OffCampusView extends BaseFrame {
    ...
    private final JTextField dateField = new JTextField(10); // yyyy-mm-dd (or any text)
    ...
    private JPanel buildForm() {
        ...
        form.setBorder(BorderFactory.createTitledBorder("Add / Edit"));
